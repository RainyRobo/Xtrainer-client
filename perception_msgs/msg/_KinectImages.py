...
"""autogenerated by genpy from perception_msgs/KinectImages.msg. Do not edit."""
import codecs
import sys
...
class KinectImages(genpy.Message):
  _md5sum = "6f0a7506ee8ec4b95ccb1506ef6b9489"
  _type = "perception_msgs/KinectImages"
...
"""
  __slots__ = ['header','color_image','depth_image','ir_image','point_cloud']
  _slot_types = ['std_msgs/Header','sensor_msgs/CompressedImage','sensor_msgs/CompressedImage','sensor_msgs/CompressedImage','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,color_image,depth_image,ir_image,point_cloud
    ...
    """
    if args or kwds:
      super(KinectImages, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.color_image is None:
        self.color_image = sensor_msgs.msg.CompressedImage()
      if self.depth_image is None:
        self.depth_image = sensor_msgs.msg.CompressedImage()
      if self.ir_image is None:
        self.ir_image = sensor_msgs.msg.CompressedImage()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.ir_image.header.seq, _x.ir_image.header.stamp.secs, _x.ir_image.header.stamp.nsecs))
      _x = self.ir_image.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.ir_image.format
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.ir_image.data
      length = len(_x)
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(struct.Struct('<I%sB'%length).pack(length, *_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.color_image.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.color_image.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.depth_image.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.depth_image.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.ir_image.header.seq, _x.ir_image.header.stamp.secs, _x.ir_image.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.ir_image.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.ir_image.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.ir_image.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.ir_image.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.ir_image.data = str[start:end]
      _x = self
      start = end
      end += 12
